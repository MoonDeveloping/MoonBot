...
module.exports = {
    ...
    async execute(channel) {
        ...
        try {
            ...
            // Kanal oluşturma log aktif değilse çık
            if (!logSettings || !logSettings.channel_create) return;
            ...
            console.error(global.hata(`Kanal oluşturma log hatası: ${error.message}`));
        }
    }
};
